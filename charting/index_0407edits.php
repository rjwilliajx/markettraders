...
<link href="../../../markettraders_com/charting/style.css" rel="stylesheet" type="text/css" />
...
<body style="font-family: 'Droid Sans', sans-serif;">
	<div id="chartingcontainer">
   	  ...
   	  <div class="chartingheader">
            ...
            <div>
              <p style="text-align: center; padding: 20px 0 10px 0; font-family: 'Bitter', serif; font-size: 18px; color: #FFFFFF;">              Download &amp; Use<br />
                MTI 4.0 Charting
              Today!</p><p style="text-align: center;"><a href="#" class="clickme"><img src="images/btn-charting-download-now.png" alt="Get Started!" border="0" /></a></p>
            </div>
            <div class="clear"></div>
      </div>
      <div style="width: 100%; height: 295px; background-color:#F6F6F6; margin: 0 auto;">

        <div style="padding: 20px; width:600px; height: 250px; float: left; font-size: 13px; line-height: 18px;">
              <p style="font-size: 18px; line-height: 28px; color:#888888;">MTI 4.0 Charting serves as an all-in-one Forex charting platform and analysis tool that gives Forex traders the same reliable Forex charting tools that the pros use.</p> <br />
          <p>
              <b>Automate your Forex Analysis and Trading</b><br />
              MTI 4.0 Charting lets you analyze the Forex market with the help of over 100 indicators, drawing tools and more. This easy-to-use charting software can also increase the automation of your market analysis by utilizing the NEW! AutoTrader Charting Add-On* and the FX Juggernaut trading system.<br />
        <br />
        <strong>Charting Software Training Sessions  </strong><br />
        Receive step-by-step instruction on how to navigate, customize and maximize your charting software to fit your particular needs.</p>
</div>
            <div style="padding: 20px; width:200px; height: 100px; float: left;">
            <img src="images/mti-charting-product-box.png" /></div>
		<div class="clear"></div>
      </div>
      <div class="chartingcontentcontainer">
       	  <div class="chartingcontentleft">
          	<div class="chartingcontenttitle" style="float: left;">
                ...
                <div style="padding-top: 9px; color: #313030; font-family: 'Oswald', sans-serif; width: 275px; font-size: 22px; text-shadow: 1px 1px #fcf0c5;">WHY MTI 4.0 CHARTING?</div>
            </div>
      ...
      <div class="chartingcontentmid" style="clear: both;">
          ...
          <div class="chartingcontentmidtitle">
          	<div class="chartingcontenttitle" style="float: left;">
           	  <div style="padding: 16px; float: left;"><img src="images/charting-title-arrow.png" alt="Arrow" /></div>
                <div style="padding-top: 9px; color: #313030; font-family: 'Oswald', sans-serif; font-size: 22px; width: 260px;text-shadow: 1px 1px #fcf0c5;">EXCLUSIVE FEATURES</div>
          </div>
          ...
          <table border="0" cellspacing="10" cellpadding="0" style="text-align: center; margin: 0 auto;">
              <tr>
                <td class="chartingmidvidbox" width="218"><a href="#" class="link1"><img src="images/charting-mid-box-vid-indicator.png" alt="Video" style="margin-top: 32px;" /></a><p style="font-family: 'Droid Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000000; text-align: left; padding: 15px; padding-bottom: 0px; line-height: 150%;">100+ Charting Indicators</p><p style="font-family: 'Droid Sans', sans-serif; font-size: 12px; text-align: left; padding: 15px; padding-top: 0px; line-height: 150%;">MTI 4.0 Charting offers over 100 charting indicators right at your fingertips.</p></td>
                <td class="chartingmidvidbox" width="218"><a href="#" class="link2"><img src="images/charting-mid-box-vid-bars.png" alt="Video" style="margin-top: 32px;" /></a>
                <p style="font-family: 'Droid Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000000; text-align: left; padding: 15px; padding-bottom: 0px; line-height: 150%;">30k Bars of Memory</p>
                <p style="font-family: 'Droid Sans', sans-serif; font-size: 12px; text-align: left; padding: 15px; padding-top: 0px; line-height: 150%;">Find patterns in the market up to a few years back  in order to help you make future trading decisions.</p></td>
                <td class="chartingmidvidbox" width="218"><a href="#" class="link3"><img src="images/charting-mid-box-vid-system.png" alt="Video" style="margin-top: 32px;" /></a>
                <p style="font-family: 'Droid Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000000; text-align: left; padding: 15px; padding-bottom: 0px; line-height: 150%;">Forex Trading System</p>
                ...
                <td class="chartingmidvidbox" width="218"><a href="#" class="link4"><img src="images/charting-mid-box-vid-autotrader.png" alt="Video" border="0" style="margin-top: 32px;" /></a><p style="font-family: 'Droid Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000000; text-align: left; padding: 15px; padding-bottom: 0px; line-height: 150%;">Automated System Trader</p>
                <p style="font-family: 'Droid Sans', sans-serif; font-size: 12px; text-align: left; padding: 15px; padding-top: 0px; line-height: 150%;">Automate signals generated by systems on your charting software to your demo trading account<sup><span style="font-family: Arial, Helvetica, sans-serif;">&Dagger;</span></sup>.</p></td>
              </tr>
          </table>
        </div>
      ...
      <div class="chartingordercontenttitle-2 clickme" style="float: left;"></div>
         <!--<div class="chartingordercontenttitle" style="background-color:#FFFF00; float: left;">



          	<div class="chartingcontenttitle" style="float: left;">
           	  <div style="padding: 16px; float: left;"><img src="images/charting-title-arrow.png" alt="Arrow" /></div>
                <div style="padding-top: 9px; color: #313030; font-family: 'Oswald', sans-serif; font-size: 22px; width: 200px; text-shadow: 1px 1px #fcf0c5; cursor: pointer;" class="clickme" >ORDER NOW</div>
          </div>
          <div style="float: left;"><img src="images/charting-title-bar-right.png" alt="Title Bar Edge" /></div>
       ...
       <div style="padding: 20px; font-size:13px; line-height: 18px;"> You're just a few steps away from being able to download your MTI 4.0 Charting software package. Upon submitting a completed form, you will be given immediate access to download the MTI 4.0 Charting software and will be emailed additional features associated with this package.</div>
...
<!-- https://secure.authorize.net/gateway/transact.dll -->
        ...
        <div id="step-1"><span class="step-title">STEP 1 -Set up Account</span><br /><span class="step-title-sub">Enter billing information</span><br />
          ...
          <br />
            ...
            <!-- FORM -->
            <img src="../../../markettraders_com/charting/img/btn-purchase-subscription.png" width="169" height="40" id="validate" style="cursor: pointer;"/>
		<div style="display: none;"><input type="submit" id="submit" /></div>
            <input type="hidden" name="submitted" value="true" />
          <p align="center"><img src="../../../markettraders_com/charting/img/authorize_net_87x69.png" /><br /><br /><img src="../../../markettraders_com/charting/img/VS_GD_light.gif" width="132" height="31" /></p></div>
            <div class="clear"></div>
        </div>
    </div>
    </form>

    <div style="width:920px; padding: 20px; text-align:center; font-size: 12px; line-height: 18px;">
    <p align="center"><span style="font-family: Arial, Helvetica, sans-serif;">* Currently only interfaces with FXCM demo accounts. More brokerage options will be available in the future.<br /><br /><sup>&Dagger;</sup></span>Currently, this AutoTrader Charting Add-on only interfaces with FXCM demo accounts. More brokerage options will become available in the future.</p><br />
    Market Traders Institute, Inc.<br /><br />
International: 1-407-740-0900 | USA & Canada: 1-800-866-7431 | Fax: 1-407-740-0201<br /><br />Trading foreign exchange on margin carries a high level of risk, and may not be suitable for all investors. The high degree of leverage can work against you as well as for you. Before deciding to trade foreign exchange you should carefully consider your investment objectives, level of experience, and risk appetite. The possibility exists that you could sustain a loss of some or all of your initial investment and therefore you should not invest money that you cannot afford to lose. You should be aware of all the risks associated with foreign exchange trading, and seek advice from an independent financial advisor if you have any doubts.</div>
    </div>
