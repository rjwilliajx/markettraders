...
<body style="font-family: 'Droid Sans', sans-serif;">
	<div id="chartingcontainer">
   	  ...
   	  <div class="chartingheader">
            ...
            <div>
              <p style="text-align: center; padding: 20px 0 10px 0; font-family: 'Bitter', serif; font-size: 18px; color: #FFFFFF;">Download &amp;<br/> Get Started Immediately</p><p style="text-align: center;"><a href="#" class="clickme"><img src="images/btn-charting-get-started.png" alt="Get Started!" border="0" /></a></p>
            </div>
            <div class="clear"></div>
      </div>
