...
<body style="font-family: 'Droid Sans', sans-serif;">
	<div id="chartingcontainer">
   	  ...
   	  <div class="chartingheader">
            ...
            <div>
              <p style="text-align: center; padding: 20px 0 10px 0; font-family: 'Bitter', serif; font-size: 18px; color: #FFFFFF;">Get Started &amp;<br/>Download Now</p><p style="text-align: center;"><a href="#" class="clickme"><img src="images/btn-charting-get-started.png" alt="Get Started!" border="0" /></a></p>
            </div>
            <div class="clear"></div>
      </div>
      <div style="width: 100%; height: 295px; background-color:#F6F6F6; margin: 0 auto;">
            ...
            <div style="padding: 20px; width:600px; height: 250px; float: left; font-size: 13px; line-height: 18px;">
              <p style="font-size: 18px; line-height: 28px; color:#888888;">MTI’s 4.0 Charting serves as an all-in-one Forex charting platform and analysis tool that gives Forex traders the same reliable Forex charting tools that the pros use.</p> <br />
          <p>
              <b>Utilize Your Charting Today</b><br />
              Order your MTI 4.0 Charting subscription for just $99/month and immediately take advantage of our hottest features, such as the AutoTrader Charting Add-on, where you can automate signals generated by the systems inside your charting software to your demo trading account and the FX Juggernaut trading system, capable of monitoring the market and alerting you of savory market movement. <br />
        <br />
        <b>Maximize Your Charting Software</b><br />
Classes are available that will show you how to navigate through the software, how to customize your charting software to fit your needs and how to maximize its features.</p>
</div>
      ...
      <div class="chartingcontentmid" style="clear: both;">
          ...
          <table border="0" cellspacing="10" cellpadding="0" style="text-align: center; margin: 0 auto;">
              <tr>
                ...
                <td class="chartingmidvidbox" width="218"><a href="#" class="link4"><img src="images/charting-mid-box-vid-autotrader.png" alt="Video" style="margin-top: 32px;" /></a><p style="font-family: 'Droid Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000000; text-align: left; padding: 15px; padding-bottom: 0px; line-height: 150%;">Automated System Trader</p>
      ...
      <div class="chartingordercontenttitle-2" style="float: left;"></div>
